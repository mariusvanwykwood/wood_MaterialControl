<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FunctionSelect.aspx.cs" Inherits="Wood_MaterialControl.FunctionSelect" EnableEventValidation="false" %>
...
<body>
    ...
    <nav>
        <div class="navigation-header">
            <a href="Default.aspx" title="Iso Control"  >
    ...
    <form id="form1" runat="server">
        <div id="divstartup" runat="server" style="padding-left: 20px;">
            <h2 runat="server" id="mainh1" style="text-align:left;">Function Selection</h2> 
 <br />
 <br />
<asp:Button ID="btnMatcon" runat="server" OnClick="btnMatcon_Click" Text="Material Control" />&nbsp;&nbsp;<asp:Button ID="btnIsoReview" runat="server" OnClick="btnIsoReview_Click" Text="ISO Material Release" /><br />
           </div>
