...
<asp:Panel ID="pnlAddForm" runat="server" Visible="false" >
    <table class="table table-bordered">
        ...
        <tr>
            <td>Ident:</td>
            <td>
                <asp:DropDownList ID="ddlAddIdent" runat="server" />
            </td>
        </tr>
        <tr>
...
    OnClick="btnSubmit_Click" />
        ...
        <br />
        <asp:Button ID="btnviewspmat" runat="server" Text="View SPMAT File" OnClick="btnviewspmat_Click" CssClass="hidden" />  
        <br />
...
    OnRowCommand="gvSPMAT_RowCommand">
    
    <Columns>
...
    <br />
    <asp:Button ID="btnExportSPMAT" runat="server" Text="Export to Excel" OnClick="btnExportSPMAT_Click"/>
</asp:Panel>
